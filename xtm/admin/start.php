...
define('RSS_FEED_TITLE', 'xtcModified Support Forum - Ank&uuml;ndigungen / Neuigkeiten');
define('RSS_FEED_DESCRIPTION', 'Aktuelle Information von xtcModified Support Forum');
define('RSS_FEED_LINK', 'http://www.xtc-modified.org/blog/');
define('RSS_FEED_ALTERNATIVE', 'Leider k&ouml;nnen die aktuellen Neuigkeiten nicht im RSS Feed dargestellt werden. Bitte besuchen sie unseren Blog unter <a href="'.RSS_FEED_LINK.'">www.xtc-modified.org/blog</a> um wichtige Informationen f&uuml;r Shopbetreiber zu diesen Themen zu erfahren: <ul><li>Wichtige Updates und Fixes</li><li>Funktionserweiterungen</li><li>Rechtssprechungen</li><li>Neuigkeiten</li><li>Klatsch und Tratsch</li></ul>');
...
<!-- body_text //-->
	...
	<tr>
	  ...
	  <td width="48%" class="infoBoxHeading" style="border: 1px solid #b40076; border-bottom: 1px solid #b40076;"><span style="margin-left: 3px"><font face="Verdana"><strong><?php echo TABLE_CAPTION_NEWSFEED; ?></strong> <a href="http://www.xtc-modified.org/blog" target="_blank">xtcModified.org Blog</a></font></span></td>
	</tr>
	<tr>
	...
	?>
	  ...
	  <td style="background: #F9F0F1; border: 1px solid #b40076;" height="200" valign="top">
	    <table border="0" width="98%" cellspacing="0" cellpadding="0">
        <?php        
        $feed = parseRSS('http://www.xtc-modified.org/feed/', 2);    
        if ($feed && class_exists('SimpleXmlElement')) {
          ...
          <div style="background:#F0F1F1;font-size:11px; border:1px solid #999; padding:5px; font-weight: 700" align="left">
            <div style="width:40px; height:100%; float:left;"><img src='http://images.xtc-modified.org/xtcmodifiedfeed105<?php echo (substr(PROJECT_VERSION, (strpos(PROJECT_VERSION, 'SP')))); ?>.gif' border='0' alt=''></div><a target="_blank" href="<?php echo $rss->channel->link; ?>"><?php echo utf8_decode($rss->channel->title); ?></a>
            <br/>
        ...
        ?>
          <div style="background:#F0F1F1;font-size:11px; border:1px solid #999; padding:5px; font-weight: 700" align="left">
            <div style="width:40px; height:100%; float:left;"><img src='http://images.xtc-modified.org/xtcmodifiedfeed105<?php echo (substr(PROJECT_VERSION, (strpos(PROJECT_VERSION, 'SP')))); ?>.gif' border='0' alt=''></div><a target="_blank" href="<?php echo RSS_FEED_LINK; ?>"><?php echo RSS_FEED_TITLE; ?></a>
            <br/>
