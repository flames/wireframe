  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._refreshElements = function(from_node) {
      ...
      createNodeLi = function(node) {
        ...
        return $("<li><div><span class=\"jqtree-title\">" + escaped_name + "</span><div style=\"margin:0 0 0 0; float:right; width:300px; margin-top:8px;\" class=\"btn-group\">"+
            "<button onclick=\"window.location = '?edit="+node.id+"'\" class=\"btn btn-success\" type=\"button\" title=\"Bearbeiten\">"+
                        "<i class=\"icon-edit icon-white\"></i>"+
                        "<span></span>"+
                    "</button>"+
                    "<button onclick=\"window.location = '?edit="+node.id+"&amp;e_copy=1'\" class=\"btn btn-success\" type=\"button\" title=\"Kopieren\">"+
                        "<i class=\"icon-share icon-white\"></i>"+
                        "<span></span>"+
                    "</button>"+
                    "<button onclick=\"var r=confirm('Wollen sie den Eintrag wirklich löschen?'); if (r==true) ajax_action('delete','wf_sites','"+node.id+"');\" class=\"del_button btn btn-danger\" id=\"delete_button_"+node.id+"\" type=\"button\" title=\"Löschen\">"+
...
"</div></div></li>");
      ...
      createFolderLi = function(node) {
        ...
        escaped_name = escapeIfNecessary(node.name);
        return $("<li class=\"" + folder_class + "\"><div><a class=\"" + button_class + "\">&raquo;</a><span class=\"jqtree-title\">" + escaped_name + "</span><div style=\"margin:0 0 0 0; float:right; width:300px; margin-top:8px;\" class=\"btn-group\">"+
            "<button onclick=\"window.location = '?edit="+node.id+"'\" class=\"btn btn-success\" type=\"button\" title=\"Bearbeiten\">"+
                        "<i class=\"icon-edit icon-white\"></i>"+
                        "<span></span>"+
                    "</button>"+
