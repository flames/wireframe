 ...
 (function($) {
	 ...
	 var methods = {
			...
			for (var i = 0; i < rules.length; i++) {
				...
				switch (rules[i]) {
					...
					case "required":
						...
						break;
                    case "checked_required":
                        required = true;
                        errorMsg = methods._checked_required(field, rules, i, options);
                        break;
					case "custom":
		...
		*/
         ...
         * @return an error string if validation failed
         */
        _checked_required: function(field, rules, i, options) {
            if( $('#use_del').attr('checked') == "checked"){
            switch (field.prop("type")) {
                case "text":
                case "password":
                case "textarea":
